...
// render images in appropriate spot
// examine data point: if array, array.map where it belongs
```
3. I can add a new plant to the page by submitting the form.
4. I can mark a plant as "sold out".
5. I can search for plants by their name and see a filtered list of plants.
